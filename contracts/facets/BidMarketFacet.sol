...
contract BidMarketFacet is IBidMarket {
    ...
    function placeBid(BidInputParams calldata bidInputParams) public override {
        ...
        LibRewardsUtils.checkForCompetitiveBidIncrement(msg.sender, bidInputParams.nft, bidInputParams.amount);
    ...
    function withdrawBid(uint256 bidId) public override {
        ...
        LibRewardsUtils.checkForCompetitiveBidDecrement(
            msg.sender,
    ...
    function acceptBid(uint256 bidId) external override {
        ...
        LibRewardsUtils.checkForSaleReward(msg.sender, bidInfo.bidInput.nft, bidInfo.bidInput.amount);
